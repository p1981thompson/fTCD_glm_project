...
fTCD_glm_A2<-function(path,order)
{
...
pdf(file = 'HRF_signals_plots_A2project_SG.pdf', onefile = TRUE) #print plots to file.
my_results_A2_SG<-fTCD_glm_A2(path=paste0(getwd(),'/A2_SG_data'),order=order)
dev.off()
