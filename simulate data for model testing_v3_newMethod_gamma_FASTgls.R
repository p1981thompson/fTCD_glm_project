#=========================================================================================================#
# Simulation code - gammma HRF (fastGLS)
#=========================================================================================================#
...
res_all<-do.call("rbind", list(CI_mod1,CImod2))

res_all$type<-rep(c('FASTgls','gls'),each=8)
...
ggplot(data=res_all,
  ...
  xlab('Type (FASTgls or GLS)')+ ylab("mean estimate")+
