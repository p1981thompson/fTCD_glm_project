...
write.csv(mod1,"/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/simulations_newMethod/lm_gamma_results1_inc_corErr0.7_newmethod.csv")
write.csv(mod2,"/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/simulations_newMethod/gls_gamma_results1_inc_corErr0.7_newmethod.csv")

write.csv(se1,"/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/simulations_newMethod/lm_gamma_results1_inc_corErr0.7_SE_newMethod.csv")
write.csv(se2,"/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/simulations_newMethod/gls_gamma_results1_inc_corErr0.7_SE_newMethod.csv")
...
write.csv(CI_mod1,"/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/simulations_newMethod/lm_gamma_results1_CIs_inc_corErr0.7_newMethod.csv")
...
res3<-read.csv("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/simulations_newMethod/lm_gamma_results1_CIs_inc_corErr0.7_newMethod.csv")
res4<-read.csv("/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/simulations_newMethod/gls_gamma_results1_CIs_inc_corErr0.7_newMethod.csv")
...
ggsave('/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/simulations_newMethod/gls_gamma_results1_estimate_boot CI_inc_corErr0.7_newMethod.png')
...
ggsave('/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/simulations_newMethod/gls_gamma_results1_SE_boot CI_inc_corErr0.7_newMethod.png')
