...
\articletype{ARTICLE for `LATERALITY'}

\title{Novel analytic methods for functional Transcranial Dopppler ultrasound
using general linear models}


\author{\name{Zoe Woodhead$^{a, \dagger, \ddagger}$, Paul Thompson$^{a}$, Kate Watkins$^{a}$, Dorothy Bishop$^{a}$}
\affil{$^{a}$Department of Experimental Psychology, Anna Watts Building, Radcliffe
Observatory Quarter,Woodstock Road, Oxford, OX2 6GG, UK.}
}

\thanks{CONTACT Zoe Woodhead. Email: \href{mailto:zoe.woodhead@psy.ox.ac.uk}{\nolinkurl{zoe.woodhead@psy.ox.ac.uk}}, Paul Thompson. Email: , Kate Watkins. Email: , Dorothy Bishop. Email: }
...
\begin{keywords}
General linear model; fTCD; fMRI; Laterality
\end{keywords}
...
\includegraphics[width=0.8\linewidth]{fTCD_glm_paper_files/figure-latex/pressure-1}
...
\centering
\subfigure[An example of an individual figure sub-caption.]{%
\resizebox*{5cm}{!}{\includegraphics{/var/folders/56/2nct3xsn4n11g7bjnlf76wz00000gq/T//Rtmp6QDfrv/file8941811c62f.pdf}}}\hspace{5pt}
\subfigure[A slightly shorter sub-caption.]{%
\resizebox*{5cm}{!}{\includegraphics{/var/folders/56/2nct3xsn4n11g7bjnlf76wz00000gq/T//Rtmp6QDfrv/file8941811c62f.pdf}}}
\caption{Example of a two-part figure with individual sub-captions
 showing that captions are flush left and justified if greater
 than one line of text.} \label{sample-figure}
\end{figure}
...
research. Thanks to Professor Nathalie Tzourio-Mazoyer for kindly
providing the task materials on which the sentence generation task was
based. Finally, thanks to Holly Rutherford for assistance with data
collection.
...
{[}694189{]} (DVMB, ZW and PT). KW was supported by \ldots{}
