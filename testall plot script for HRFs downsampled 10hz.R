...
pdf(file = 'HRF_signals_plots_A2project_SG_rcpp_downsamp10hz_TESTALL.pdf', onefile = TRUE) #print plots to file.
#start_time = Sys.time()
fTCD_glm_A2_rcpp(path="/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/A2_SG_data",order=order)
#end_time = Sys.time()
