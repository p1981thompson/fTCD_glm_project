...
pdf(file = '/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/Chpt4_fTCD_WordGen_rawdata/HRF_signals_plots_LISA_WG_AutoCor_Err_Downsampled5Hz_gamma.pdf', onefile = TRUE) #print plots to file.
my_results_LISA_WG_AutoCor_Err_downsampled5Hz_gamma<-fTCD_glm_LISA_AC(path='/Volumes/PSYHOME/PSYRES/pthompson/DVMB/fTCD_glm_project/Chpt4_fTCD_WordGen_rawdata',order=order)
dev.off()
my_results_LISA_WG_AutoCor_Err_downsampled5Hz_gamma<-my_results_LISA_WG_AutoCor_Err_downsampled5Hz_gamma[complete.cases(my_results_LISA_WG_AutoCor_Err_downsampled5Hz_gamma), ]
#-----------------------------------------------------------------------------------------------------------------------#
...
# 
my_results_LISA_WG_ex_AutoCor_Err_downsampled5Hz_gamma <- my_results_LISA_WG_AutoCor_Err_downsampled5Hz_gamma[!my_results_LISA_WG_AutoCor_Err_downsampled5Hz_gamma$ID %in% exclude_id,]
# 
# 
# 
# #-----------------------------------------------------------------------------------------------------------------------#
# --------------------------------------------------------------------------------------------------------------#
# 
my_results_LISA_WG_ex_AutoCor_Err_downsampled5Hz_gamma$ID <- substring(my_results_LISA_WG_ex_AutoCor_Err_downsampled5Hz_gamma$ID,4,6)
# 
# 
# #-----------------------------------------------------------------------------------------------------------------------#
library(psych)
...
compare_results<-merge(my_results_LISA_WG_ex_AutoCor_Err_downsampled5Hz_gamma,old_res,by='ID',all.x = T)
